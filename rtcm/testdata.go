...
var incompleteMessageArray = [6]byte{0xd3, 0x00, 0xaa, 0x46, 0x70, 0x00}
var incompleteMessage []byte = incompleteMessageArray[:]

// Four bytes of junk which should be returned as a non-RTCM message,
// followed by the start of message byte.
var junkBytesAtStart = [10]byte{'j', 'u', 'n', 'k', ' ', 'j', 'u', 'n', 'k', 0xd3}
var junkAtStart []byte = junkBytesAtStart[:]

// Four bytes of junk which should be returned as a non-RTCM message,
var allJunkBytes = [4]byte{'j', 'u', 'n', 'k'}
var allJunk []byte = allJunkBytes[:]

// We should get this result when we read the junkAtStartReader or the junkReader.
const wantJunk = "junk"

//
var codeBiasArray = [...]byte{0xd3, 0, 0x08,
	0x4c, 0xe0, 00, 0x8a, 0, 0, 0, 0,
	0xa8, 0xf7, 0x2a,
}

var codeBias []byte = codeBiasArray[:]
...
// This slice contains the expected result when the data above
// is processed by ProcessMessages.
//
var expectedResultFromProcessMessages []byte = expectedBytes[:]

// d4 contains MSM4 messages.
var d4 = [...]byte{
