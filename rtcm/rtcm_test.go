...
// testDelta7 is the delta value used to test floating point
// values for equality to seven decimal places.
const testDelta7 = 0.0000001
...
// floatsEqualWithin7 returns true if two float values are equal
// within 7 decimal places.
func floatsEqualWithin7(f1, f2 float64) bool {
	if f1 > f2 {
		return (f1 - f2) < testDelta7
	}

	return (f2 - f1) < testDelta7
}
